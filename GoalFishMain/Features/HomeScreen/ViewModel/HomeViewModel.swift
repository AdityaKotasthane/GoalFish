...
//    @Published var isShowingTagList = false
    ...
    let tagColors: [Color] = [
        Color(hex: "#5FA8D3"),  // Serene Ocean Blue
        Color(hex: "#62B6AB"),  // Tranquil Seafoam
        Color(hex: "#CAE9FF"),  // Gentle Sky Blue
        Color(hex: "#1B4965"),  // Deep Ocean Blue
        Color(hex: "#00B4D8")   // Vibrant Turquoise
    ]
    let allFishes: [String: String] = [
        ...
        "Puffball": "fish7",
        "Turtango": "turtle2",
        "Meduzo": "octopus",  // New Lottie animation
        "Turtley": "turtle3"     // New Lottie animation   NEW FILE
    ]
